...
ggplot(dados_ies, aes(x = REGIAO, fill = REDE)) +
  ...
  labs(
    title = 'Distribuição de Instituições por Região e Tipo de IES (Pública x Privada)',
    x = 'Região',
    y = 'Quantidade de Instituições'
  ) +
  scale_fill_discrete(name = "NOME_CURSO de Instituição") + # Define o título da legenda
  theme_minimal() +
  theme(
