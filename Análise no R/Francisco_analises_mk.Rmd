...
dados_escolaridade %>% group_by(escolaridade)

  kable(
    format = "html",
    caption = "Distribuição Geral por Nível de Escolaridade",
    col.names = c("Nível de Escolaridade", "Quantidade", "Percentual", "Percentual Acumulado")
  ) %>%
  kable_styling(
  ...
  add_header_above(c(" " = 1, "Distribuição" = 3))
```
